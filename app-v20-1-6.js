...
const APP_BUILD_ID = '20260901-20106-glance1';
...
const MOBILE_DATA_CACHE_VERSION = '20.1.6-premium-command-centre-1';
const state = {
...
console.info('SarNi v20.1.6 loaded — premium responsive command centre ready');
