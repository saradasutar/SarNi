...
const APP_BUILD_ID = '20260824-1948-smoothlogin-gpf1';
...
const MOBILE_DATA_CACHE_VERSION = '19.4.8-smooth-login-gpf-1';
const state = {
...
console.info('MyFinance v19.4.8 loaded — smooth login, shared holdings recovery, GPF and professional diary enabled');
