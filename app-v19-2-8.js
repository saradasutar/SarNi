...
function restoreHoldingsSummaryState(){
  applyHoldingsSummaryState(holdingsSummaryOpenPreference(),{save:false});
}
...
console.info('MyFinance v19.2.8 loaded — colour-coded Holdings Summary');
