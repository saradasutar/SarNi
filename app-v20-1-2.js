...
const APP_BUILD_ID = '20260901-20102-security1';
...
const MOBILE_DATA_CACHE_VERSION = '20.1.2-premium-command-centre-1';
const state = {
...
console.info('SarNi v20.1.2 loaded — premium responsive command centre ready');
