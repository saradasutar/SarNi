...
const APP_BUILD_ID = '20260825-19417-matrix1';
...
const MOBILE_DATA_CACHE_VERSION = '19.4.17-vibrant-matrix-1';
const state = {
...
function setGpfHoldingSummary(prefix,items){
  ...
  if(interest)interest.textContent=formatCurrency(total.interest,true);
...
console.info('MyFinance v19.4.17 loaded — vibrant overlap-free Sarada, Niharika and Combined matrix enabled');
