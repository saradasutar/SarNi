...
const APP_BUILD_ID = '20260825-19411-directlogin1';
...
const MOBILE_DATA_CACHE_VERSION = '19.4.11-direct-login-1';
const state = {
...
console.info('MyFinance v19.4.11 loaded — direct secure login reply and overlap-free holdings summary enabled');
