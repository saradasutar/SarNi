...
const APP_BUILD_ID = '20260825-19412-native1';
...
const MOBILE_DATA_CACHE_VERSION = '19.4.12-native-secure-1';
const state = {
...
console.info('MyFinance v19.4.12 loaded — same-origin Apps Script mode and overlap-free holdings summary enabled');
