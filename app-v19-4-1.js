...
const MOBILE_DATA_CACHE_VERSION = '19.4.0-expenditure-1';
const state = {
...
console.info('MyFinance v19.4.1 loaded — smooth UI + 5-minute idle logout');
