...
const APP_BUILD_ID = '20260824-1942-cacheheal1';
...
const MOBILE_DATA_CACHE_VERSION = '19.4.2-cache-self-heal-1';
const state = {
...
console.info('MyFinance v19.4.2 loaded — browser cache/session self-heal enabled');
