...
const APP_BUILD_ID = '20260830-20001-lightfix1';
...
const MOBILE_DATA_CACHE_VERSION = '20.0.1-premium-command-centre-1';
const state = {
...
console.info('SarNi v20.0.1 loaded — premium responsive command centre ready');
