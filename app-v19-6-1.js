...
const APP_BUILD_ID = '20260830-19601-namedviews1';
...
const MOBILE_DATA_CACHE_VERSION = '19.6.1-named-views-1';
const state = {
...
['watchPerformanceFilter','watchRangeFilter','watchCapFilter','watchResearchFilter','holdSumSaradaMfInvested','holdSumSaradaMfCurrent','holdSumSaradaMfGrowth','holdingsNamedViewSelect','holdingsNamedViewName','holdingsSaveNamedViewBtn','holdingsApplyNamedViewBtn','holdingsDeleteNamedViewBtn','holdingsNamedViewStatus','watchNamedViewSelect','watchNamedViewName','watchSaveNamedViewBtn','watchApplyNamedViewBtn','watchDeleteNamedViewBtn','watchNamedViewStatus'].forEach(id=>{els[id]=$(id);});
...
console.info('SarNi v19.6.1 loaded — named Holdings and Watchlist views enabled');
